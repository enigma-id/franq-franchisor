...
interface DeliveryPlanPrintProps {
  data?: any;
}

const DeliveryPlanPrint = ({ data }: DeliveryPlanPrintProps) => {
  if (!data) return null;
    ...
    <div className='sheet page-break' style={{ padding: "15px" }}>
      ...
      >
        <tbody>
          ...
          <tr>
            <td style={{ verticalAlign: "top" }}>Tipe</td>
            <td style={{ verticalAlign: "top" }}>:</td>
          ...
          <tr>
            <td style={{ verticalAlign: "top" }}>Tanggal Kirim</td>
            <td style={{ verticalAlign: "top" }}>:</td>
            <td>{formatDate(data.shipping_date)}</td>
          </tr>
          <tr>
        ...
        >
          <tbody>
            <tr>
              ...
              <td style={{ width: "5%" }}>:</td>
              <td style={{ width: "60%" }}>
                {`${data.brand?.name ? data.brand.name + " - " : ""}${data.outlet?.name ?? data.name ?? "-"}`}
              </td>
            </tr>
            <tr>
              <td>Phone</td>
...
export default DeliveryPlanPrint;
