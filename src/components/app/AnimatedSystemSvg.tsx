      ...
      >
        ...
        >
          ...
          <circle
            ...
            fill="currentColor"
            className="text-primary"
            style={{ animation: "pulse-glow 3s infinite 0s", transform: "translateZ(90px)" }}
          />
          <circle
            cx="650"
            cy="220"
            r="4"
            fill="#10b981"
            style={{ animation: "pulse-glow 4s infinite 1s", transform: "translateZ(70px)" }}
          />
          <circle
            cx="450"
            cy="620"
            ...
            fill="currentColor"
            className="text-primary"
            style={{ animation: "pulse-glow 2.5s infinite 0.5s", transform: "translateZ(100px)" }}
          />
          <circle
            cx="280"
            cy="380"
            r="5"
            fill="#3b82f6"
            style={{ animation: "pulse-glow 3.5s infinite 2s", transform: "translateZ(120px)" }}
          />
          ...
          <circle
            ...
            r="3"
            fill="#f59e0b"
            style={{ animation: "pulse-glow 2s infinite 0.3s", transform: "translateZ(150px)" }}
          />
          <circle
            cx="580"
            cy="480"
            ...
            fill="currentColor"
            className="text-primary"
            style={{ animation: "pulse-glow 5s infinite 1.2s", transform: "translateZ(80px)" }}
          />
          <circle
            cx="180"
            cy="520"
            r="4"
            fill="#8b5cf6"
            style={{ animation: "pulse-glow 3s infinite 0.7s", transform: "translateZ(110px)" }}
          />
          <circle
            cx="500"
            cy="180"
            r="5"
            fill="#ec4899"
            style={{ animation: "pulse-glow 4.5s infinite 2.5s", transform: "translateZ(140px)" }}
          />
          <circle
            cx="680"
            cy="380"
            r="6"
            fill="#14b8a6"
            style={{ animation: "pulse-glow 2.8s infinite 1.8s", transform: "translateZ(95px)" }}
          />
          <circle
            cx="220"
            cy="120"
            ...
            fill="currentColor"
            className="text-primary"
            style={{ animation: "pulse-glow 3.2s infinite 0.9s", transform: "translateZ(130px)" }}
          />
          <circle
            cx="380"
            cy="680"
            r="5"
            fill="#f43f5e"
            style={{ animation: "pulse-glow 4s infinite 1.5s", transform: "translateZ(60px)" }}
          />
          ...
          <path
            ...
            style={{ animation: "dash-flow 2s linear infinite", transform: "translateZ(40px)" }}
          />
          <path
            ...
            strokeWidth="4"
            strokeDasharray="8 8"
            style={{ animation: "dash-flow 1.5s linear infinite reverse", transform: "translateZ(35px)" }}
          />
          <path
            ...
            strokeWidth="2"
            strokeDasharray="6 6"
            style={{ animation: "dash-flow 3s linear infinite", transform: "translateZ(20px)" }}
          />
          <path
            ...
            strokeWidth="3"
            strokeDasharray="5 5"
            style={{ animation: "dash-flow 2.5s linear infinite reverse", transform: "translateZ(45px)" }}
          />
          ...
          <path
            ...
            strokeWidth="2"
            strokeDasharray="4 4"
            style={{ animation: "dash-flow 4s linear infinite", transform: "translateZ(25px)" }}
          />
          <path
            ...
            strokeWidth="2"
            strokeDasharray="8 4"
            style={{ animation: "dash-flow 2.2s linear infinite reverse", transform: "translateZ(55px)" }}
          />
          <path
            ...
            style={{ animation: "dash-flow 1.8s linear infinite", transform: "translateZ(65px)" }}
          />
          <path
            ...
            style={{ animation: "dash-flow 3.5s linear infinite reverse", transform: "translateZ(85px)" }}
          />
        </g>
      </svg>
    </div>
