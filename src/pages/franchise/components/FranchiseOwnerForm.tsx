...
interface FranchiseOwnerFormProps {
  id?: string;
...
/**
 * Form khusus update user owner brand (franchisor).
 ...
 */
export const FranchiseOwnerForm: React.FC<FranchiseOwnerFormProps> = ({
...
export default FranchiseOwnerForm;
