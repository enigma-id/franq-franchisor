      ...
      content: (
        ...
        >
          ...
          <Modal.Body className="text-sm font-normal text-slate-600 leading-5">
            <p>
              Apakah Anda yakin ingin menghapus pos channel{" "}
    ...
    <Page className="h-full flex flex-col min-h-0 bg-slate-50">
      ...
      <Page.Body className="flex-1 flex flex-col min-h-0">
        ...
        <Table.Render
          ...
          emptyDescription="Daftar channel POS yang Anda buat akan muncul di sini."
        />
        ...
        <Modal.Body className="pt-4 pb-2 text-left">
          <form onSubmit={handleSubmit} className="space-y-4">
            <Input
              ...
              placeholder="Contoh: Counter 1, Kitchen"
              variant="primary"
...
export default POSChannelListPage;
