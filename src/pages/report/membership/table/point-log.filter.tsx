...
/** Pilihan tipe referensi point_log (mirror nilai yang di-insert backend). */
const referenceTypeOptions = [
  { label: "Earn", value: "earn" },
  { label: "Redeem", value: "redeem" },
  { label: "Revert", value: "revert" },
  { label: "Revert Earn", value: "revert_earn" },
];
...
const TableFilter: React.FC<TableFilterProps> = ({ table, lockOutlet }) => {
  ...
  }, [referenceType, dateRange, outlet, current, lockOutlet]);
