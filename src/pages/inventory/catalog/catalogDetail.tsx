...
import { formatCurrency, formatDateTime, getTypeVariant } from "@/utils";
import type { InventoryCatalogDetail } from "@/services/types";
import { Package, DollarSign, Factory, Calendar } from "lucide-react";
            ...
            <div className='card-info p-6'>
              ...
              <dl className='space-y-1'>
                ...
                <div className='info-row'>
                  ...
                  <dd className='info-value'>
                    <Badge
                      variant={getTypeVariant(catalog.item.type)}
                      size='xs'
                      className='px-2.5 font-semibold text-[10px] tracking-wider'
                    >
                      {catalog.item.type?.replace("_", " ")}
                    </Badge>
                  </dd>
                </div>
                <div className='info-row'>
          ...
          <div className='card-info p-6'>
            ...
            <dl className='grid grid-cols-2 gap-x-4 mt-4'>
              ...
              <div className='info-row'>
                ...
                <dd className='info-value'>
                  {formatDateTime(catalog.created_at)}
                </dd>
              </div>
              <div className='info-row'>
                <dt className='info-label'>Updated</dt>
                <dd className='info-value'>
                  {formatDateTime(catalog.updated_at)}
                </dd>
              </div>
            </dl>
          </div>
